  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg shadow-lg w-80 p-6 relative">
        ...
        <h2 className="text-xl font-semibold mb-4">Get Plan</h2>
        ...
        <span className='flex items-center w-full my-2 font-bold text-grey-500'>
          ...
          {brochureUrl && (
            <a
              href="logo.png"
              download
              className="block text-center text-white hover:bg-blue-700 py-2 rounded bg-blue-600 hover:underline"
            >
            Continue download
            </a>
          )}
...
const Spaces = () => {
  const SpacesData = SpaceData.slice(0, 4);
  ...
  <motion.div
    ...
    >
      ...
      <p className="text-center text-gray-500 mb-8 max-w-80 mx-auto">
        See the spaces That Fits your story
      </p>
            ...
            <SwiperSlide key={index} className="relative transition-all duration-700 hover:scale-105">
              ...
              <div className="absolute top-4 right-4 group">
                ...
                >
                  ...
                  <span className='mr-2 ml-2'>Plan</span> |<svg
