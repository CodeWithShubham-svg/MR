...
const About = () => {
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            className='flex flex-col w-ful items-center justify-center overflow-x-hidden container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
            ...
            <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
                <LazyLoadImage src={assets.brand_img} className='w-full rounded-md sm:w-3/2 max-w-lg  hover:scale-105 transition-all duration-700' />
