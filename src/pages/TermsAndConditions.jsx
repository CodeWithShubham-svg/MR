...
const PrivacyPolicy = () => {
 ...
 style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('/header_img.png')`, paddingTop: '3rem' }}
>
  <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold">Terms &amp; Condition</h1>
  <p className="mt-3 text-sm sm:text-base text-blue-100">Last updated: May 01, 2025</p>
</div>
