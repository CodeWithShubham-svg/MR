...
const NotFound = () => {
  return (
    <div className="bg-gray-50 min-h-screen w-full bg-cover bg-repeat bg-center" style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('/header_img.png')` }}>
