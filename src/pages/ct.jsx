  ...
  return (
    <div className="bg-white min-h-screen text-gray-800 font-sans">
      ...
      <div
        ...
        style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('/header_img.png')` }}
      >
        ...
        <div className="bg-white px-4 sm:px-6 py-10 max-w-7xl mx-auto border-b border-b-gray-500">
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="lg:w-1/2 ">
              ...
              <li>Let's built your dream house.</li>
...
<br>
              ...
              <div className="space-y-6">
                <div className="flex flex-col lg:flex-row gap-6">
                  <div className="bg-white p-6 border hover:scale-105 hover:border-blue-600 transition flex-1">
                    ...
                    <a href="tel:+917400001748" className="text-blue-600 block">+917400001748</a>
                    <a href="tel:+917400001749" className="text-blue-600 block">+917400001749</a>
                  </div>
        ...
        >
                  <p className="text-blue-600">Raj Heritage, Near shivar garden, Mira road (E), Maharashtra 401105</p>
                  </a>
                </div>
              </div>
            </div>
  ...
  <form onSubmit={onSubmit} className="space-y-6 animate-fadeIn mt-6">
    <div className="flex flex-wrap md:flex-nowrap gap-6">
      ...
      <div className="w-full md:w-1/2">
        ...
        <input
          className="w-full border border-gray-300 no-arrows rounded py-2 px-3 outline-blue-600 transition text-black"
          type="number"
          name="Number"
          ...
          <div className="w-full h-72 bg-gray-300 rounded-lg overflow-hidden shadow-md">
            <iframe
              className="w-full h-full"
               src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2868.4549011355057!2d72.8673304110174!3d19.29252074330886!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b1638fba7287%3A0x92a165a90f69943f!2sRaj%20Heritage%202!5e1!3m2!1sen!2sin!4v1773572279779!5m2!1sen!2sin"  
              allowFullScreen=""
              loading="lazy"
